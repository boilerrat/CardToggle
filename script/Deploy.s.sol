...
contract Deploy is Script {
  CardToggle public implementation;
  ...
  function run() public virtual {
     ...
     */
    implementation = new CardToggle{ salt: SALT}(_version /* insert constructor args here */);
...
contract DeployPrecompiled is Deploy {
  ...
  function run() public override {
    ...
    implementation = CardToggle(deployCode("optimized-out/Module.sol/Module.json", args));
